      ...
      <h5>Datos del Instrumento Jurídico</h5> 
        ...
        <div class="form-row" >
          ...
          <div class="form-group col-md-8">
            <div class="form-row">
              <h6>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Naturaleza</h6>
            </div>
            <div class="form-row">   
              <div class="form-group col-md-5">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            ControlToValidate="txtNombreRepITH" Display="Dynamic" ForeColor="Red" ValidationExpression="^[a-zA-ZÀ-ÿ0-Z0-9'@&#.ñ\s]{3,100}$"></asp:RegularExpressionValidator>
        ...
        <div class="form-group col-md-6">
          ...
          ControlToValidate="txtNombreInstitucion" Display="Dynamic" ForeColor="Red" ValidationExpression="^[a-zA-ZÀ-ÿ0-Z0-9'@&#.ñ\s]{3,100}$"></asp:RegularExpressionValidator>
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          <h6>Nombre del Representante de la Institución con la que se suscribe el instrumento jurídico</h6>
            ...
            ControlToValidate="txtNombreRepInstitucion" Display="Dynamic" ForeColor="Red" ValidationExpression="^[a-zA-ZÀ-ÿ0-Z0-9'@&#.ñ\s]{3,100}$"></asp:RegularExpressionValidator>
        ...
        <div class="form-group col-md-6">
          <h6>Cargo del Representante de la Institución con la que se suscribe el instrumento jurídico</h6>
            ...
            ControlToValidate="txtCargoRepInstitucion" Display="Dynamic" ForeColor="Red" ValidationExpression="^[a-zA-ZÀ-ÿ0-Z0-9'@&#.ñ\s]{3,100}$"></asp:RegularExpressionValidator>
