      ...
      <div class="form-row" >
        <div class="form-group col-md-8 align-content-center">
          ...
          <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
            ...
            ForeColor="Red" ValidationExpression="^[a-zA-ZÀ-ÿ0-Z0-9'@&#.ñ\s]{3,100}$"></asp:RegularExpressionValidator>
      ...
      <div class="form-row" >
        <div class="form-group col-md-8">
          ...
          <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" 
            ...
            Display="Dynamic" ForeColor="Red" ValidationExpression="^[a-zA-ZÀ-ÿ0-Z0-9'@&#.ñ\s]{3,100}$">
          </asp:RegularExpressionValidator>
