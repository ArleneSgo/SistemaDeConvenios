    ...
    <div id="contactanosFormulario" class="contactanosFormulario">
      <div class="form-row">
        <div class="form-row">
          ...
          <asp:TextBox ID="txbNombreProyecto" runat="server" Style="margin-left: 20px; 
            margin-top: 24px;" Width="335px" Height="41px"></asp:TextBox>
        </div>
      </div>
      <div class="form-row">
        <div class="form-row">
          <asp:Label ID="lbl" runat="server" Text="Número de Participantes:" style="font-size: 0.8571em;
            margin-bottom: 5px;color: #9A9A9A;"></asp:Label>
